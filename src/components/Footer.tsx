          ...
          <div className="lg:col-span-1">
            <a href="#" className="flex items-center gap-3 mb-8 group">
              <div className="relative w-12 h-12 flex items-center justify-center transition-transform duration-500 group-hover:scale-110">
                <img 
                  ...
                  className="w-full h-full object-contain rounded-xl bg-white/10 p-1 shadow-lg"
                  onError={(e) => {
            ...
            <div className="flex gap-4">
              <a 
                ...
                className="w-12 h-12 bg-white/5 rounded-2xl flex items-center justify-center hover:bg-accent transition-all hover:-translate-y-1 border border-white/10"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="w-12 h-12 bg-white/5 rounded-2xl flex items-center justify-center hover:bg-[#25d366] transition-all hover:-translate-y-1 border border-white/10"
              >
              ...
              {quickLinks.map((link, idx) => (
                <li key={idx}>
                  <a 
                    ...
                    className="text-ivory/60 hover:text-white transition-colors text-lg flex items-center gap-2 group"
                  >
